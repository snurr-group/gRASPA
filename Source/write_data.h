...
static inline void create_Restart_file(size_t Cycle, Atoms* System, Components SystemComponents, ForceField FF, Boxsize Box, std::vector<std::string> AtomNames, double3 MaxTranslation, double3 MaxRotation, size_t SystemIndex)
{
  std::ofstream textrestartFile{};
