...
inline void PRINT_ENERGY_AT_STAGE(Components& SystemComponents, int stage, Units& Constants)
{
  ...
  switch(stage)
  {
    ...
    case CREATEMOL_DELTA_CHECK: {stage_name = "CHECK DELTA_E (CREATE MOLECULE - INITIAL)"; E = SystemComponents.CreateMol_Energy; SystemComponents.SumDeltaE(E, SystemComponents.Initial_Energy, MINUS); break;}
    case DELTA_CHECK: {stage_name = "CHECK DELTA_E (FINAL - CREATE MOLECULE)"; E = SystemComponents.Final_Energy; SystemComponents.SumDeltaE(E, SystemComponents.CreateMol_Energy, MINUS); break;}
    case DRIFT: {stage_name = "ENERGY DRIFT"; E = SystemComponents.CreateMol_Energy; SystemComponents.SumDeltaE(E, SystemComponents.deltaE, ADD); SystemComponents.SumDeltaE(E, SystemComponents.Final_Energy, MINUS); break;}
  }
  printf(" *** %s *** \n", stage_name.c_str());
  printf("========================================================================\n");
