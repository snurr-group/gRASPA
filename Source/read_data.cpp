...
void CheckFrameworkCIF(Boxsize& Box, Atoms& Framework, PseudoAtomDefinitions& PseudoAtom, std::string& Frameworkfile, bool UseChargeFromCIF, double3 NumberUnitCells)
{
  std::vector<std::string> termsScannedLined{};
...
void ReadFramework(Boxsize& Box, Atoms& Framework, PseudoAtomDefinitions& PseudoAtom, size_t FrameworkIndex)
{
  ...
  {
    CheckFrameworkCIF(Box, Framework, PseudoAtom, FrameworkFile, UseChargesFromCIFFile, NumberUnitCells);
  }
