...
static inline double Reinsertion(Boxsize& Box, Components& SystemComponents, Simulations& Sims, ForceField& FF, RandomNumber& Random, WidomStruct& Widom, size_t SelectedMolInComponent, size_t SelectedComponent, bool DualPrecision)
{
  ...
  StoreNewLocation_Reinsertion<<<1,1>>>(Sims.Old, Sims.New, temp_x, temp_y, temp_z, SelectedTrial, SystemComponents.Moleculesize[SelectedComponent]);
  /////////////
  // RETRACE //
  /////////////
  ...
  { // accept the move
    ...
    Update_Reinsertion_data<<<1,SystemComponents.Moleculesize[SelectedComponent]>>>(Sims.d_a, temp_x, temp_y, temp_z, SelectedComponent, UpdateLocation);
