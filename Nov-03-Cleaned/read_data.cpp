...
// Read FF Parameters (OverlapCriteria, cutoffs) Zhao's note: alpha and prefactor are not implemented here.
double* read_FFParams_from_input()
{
  std::vector<std::string> termsScannedLined{};
  std::string str;
...
void read_component_values_from_simulation_input(Components& SystemComponents, Move_Statistics& MoveStats, size_t AdsorbateComponent, Atoms& Mol, PseudoAtomDefinitions PseudoAtom, size_t* MoleculeNeedToCreate)
{
