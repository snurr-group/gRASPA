...
static inline double Insertion(Boxsize& Box, Components& SystemComponents, Atoms*& System, Atoms*& d_a, Atoms& Mol, Atoms& NewMol, ForceField& FF, RandomNumber& Random, WidomStruct& Widom, size_t SelectedMolInComponent, size_t SelectedComponent, bool DualPrecision)
{
  ...
  double Rosenbluth=Widom_Move_FirstBead(Box, SystemComponents, System, d_a, NewMol, FF, Random, Widom, SelectedMolInComponent, SelectedComponent, Insertion, false, false, StoredR, &SelectedTrial, &SuccessConstruction, &energy, DualPrecision); //Not reinsertion, not Retrace//
  ...
  if(SystemComponents.Moleculesize[SelectedComponent] > 1 && Rosenbluth > 1e-150)
  {
    ...
    Rosenbluth*=Widom_Move_Chain(Box, SystemComponents, System, d_a, Mol, NewMol, FF, Random, Widom, SelectedMolInComponent, SelectedComponent, Insertion, false, &SelectedTrial, &SuccessConstruction, &energy, SelectedFirstBeadTrial, DualPrecision);
...
static inline double Reinsertion(Boxsize& Box, Components& SystemComponents, Atoms*& System, Atoms*& d_a, Atoms& Mol, Atoms& NewMol, ForceField& FF, RandomNumber& Random, WidomStruct& Widom, size_t SelectedMolInComponent, size_t SelectedComponent, bool DualPrecision)
{
  ...
  // INSERTION //
  ///////////////
  double Rosenbluth=Widom_Move_FirstBead(Box, SystemComponents, System, d_a, NewMol, FF, Random, Widom, SelectedMolInComponent, SelectedComponent, Insertion, true, false, StoredR, &SelectedTrial, &SuccessConstruction, &energy, DualPrecision); //Not reinsertion, not Retrace//
  if(!SuccessConstruction)
    return 0.0;
  if(SystemComponents.Moleculesize[SelectedComponent] > 1 && Rosenbluth > 1e-150)
  {
    size_t SelectedFirstBeadTrial = SelectedTrial; double temp_energy = energy;
    Rosenbluth*=Widom_Move_Chain(Box, SystemComponents, System, d_a, Mol, NewMol, FF, Random, Widom, SelectedMolInComponent, SelectedComponent, Insertion, true, &SelectedTrial, &SuccessConstruction, &energy, SelectedFirstBeadTrial, DualPrecision); //True for doing insertion for reinsertion, different in MoleculeID//
    if(!SuccessConstruction){ return 0.0;}
    energy += temp_energy;
  }
  ...
  // RETRACE //
  /////////////
  double Old_Rosen=Widom_Move_FirstBead(Box, SystemComponents, System, d_a, NewMol, FF, Random, Widom, SelectedMolInComponent, SelectedComponent, false, true, true, StoredR, &SelectedTrial, &SuccessConstruction, &old_energy, DualPrecision);
  if(SystemComponents.Moleculesize[SelectedComponent] > 1)
  {
    ...
    Old_Rosen*=Widom_Move_Chain(Box, SystemComponents, System, d_a, Mol, NewMol, FF, Random, Widom, SelectedMolInComponent, SelectedComponent, false, false, &SelectedTrial, &SuccessConstruction, &old_energy, SelectedFirstBeadTrial, DualPrecision);
