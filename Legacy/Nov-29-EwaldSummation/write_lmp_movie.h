...
static inline void WriteBox(Atoms* System, Components SystemComponents, ForceField FF, Boxsize Box, std::ofstream& textrestartFile, std::vector<std::string> AtomNames)
{
...
static inline void WriteAtoms(Atoms* System, Components SystemComponents, std::ofstream& textrestartFile, std::vector<std::string> AtomNames)
{
  size_t NumComponents = SystemComponents.Total_Components;
  textrestartFile << '\n' << "Atoms" << '\n' << '\n';
