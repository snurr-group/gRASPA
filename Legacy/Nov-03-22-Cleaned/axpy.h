...
//void CreateMolecules_Before_Simulation(Components& SystemComponents, Boxsize Box, Atoms* System, Atoms* d_a, Atoms Mol, Atoms NewMol, ForceField FF, double* y, double* dUdlambda, RandomNumber Random, WidomStruct Widom, Units Constants, bool DualPrecision, std::vector<size_t>& NumberOfCreateMolecules);
