...
* gRASPA paper is now [online](https://pubs.acs.org/doi/10.1021/acs.jctc.4c01058). Please kindly cite it if you find it useful.
  * Li, Shi, Dubbeldam, Dewing, Knight, Vázquez-Mayagoitia, Snurr, "Efficient Implementation of Monte Carlo Algorithms on Graphical Processing Units for Simulation of Adsorption in Porous Materials", _J. Chem. Theory Comput_. 2024, 20, 23, 10649–10666
